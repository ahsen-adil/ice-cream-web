export default function Visit() {
    return (
      <>
       <section className="bg-gray-100" data-aos="zoom-in-down" data-aos-duration="3000">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          <div className="max-w-full mx-auto rounded-lg overflow-hidden">
            ...
            <div className="border-t border-gray-200 px-6 py-4">
              <h3 className="text-lg font-medium text-gray-900">timming</h3>
              <p className="mt-1 text-gray-600"> Dialy / 12PM - 5AM</p>
            </div>
          </div>
        </div>
